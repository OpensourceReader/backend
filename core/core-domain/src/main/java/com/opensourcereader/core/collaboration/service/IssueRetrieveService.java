...
import com.opensourcereader.core.collaboration.repository.IssueRepository;
import com.opensourcereader.core.collaboration.repository.PullRepository;
...
public class IssueRetrieveService {
  ...
  public Issue findIssueOrPullByTagId(String owner, String repoName, Integer tagId) {
    Issue entity =
        issueRepository.findIssue(owner, repoName, tagId).orElseThrow(BoardNotFoundException::new);
    if (entity instanceof Pull pull) {
      return pull;
    } else {
      return entity;
