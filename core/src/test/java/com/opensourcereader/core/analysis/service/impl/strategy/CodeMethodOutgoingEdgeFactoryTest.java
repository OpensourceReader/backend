...
//  void createOutgoingEdges_reuse_existing_callee() {
//    // given
//    OpenSourceRepo openSourceRepo = openSourceRepoRepository.save(new
// OpenSourceRepo("clone-url"));
...
//        strategy.createOutgoingEdges(openSourceRepo.getId(), caller, List.of(call));
//
//    // then
//    CodeMethodExtractResult extractResult =
...
//  void createOutgoingEdges_create_external_when_missing() {
//    // given
//    OpenSourceRepo openSourceRepo = openSourceRepoRepository.save(new
// OpenSourceRepo("clone-url"));
//    CodeMethod caller = getCodeMethod("t/Main", "void", "run", openSourceRepo);
...
//    // when
//    List<CodeMethodCallEdge> edges =
//        strategy.createOutgoingEdges(openSourceRepo.getId(), caller, List.of(missing));
//
//    // then
