...
//            """);
//
//    DeclaredMethod target = saveInternalMethod(targetContent, "void", "target", List.of(), 3, 3);
//    DeclaredMethod outgoingMethod = saveInternalMethod(utilContent, "void", "help", List.of(), 3,
// 3);
//    DeclaredMethod ingoingMethod =
...
//
//    // when
//    DeclaredMethod found = codeMethodCallGraphService.getCodeMethodById(target.getId());
//
