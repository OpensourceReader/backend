...
// import com.opensourcereader.core.analysis.service.impl.callgraph.CodeMethodCallGraphServiceImpl;
...
//
// @SpringBootTest
// class CodeMethodCallGraphServiceImplTest {
//
//  @Autowired private CodeMethodCallGraphServiceImpl service;
...
//    CodeMethod caller =
//        saveInternalMethod(repo, callerClassName, returnType, callerDeclaredMethodName,
// List.of());
...
//
//    CodeMethodExtractResult callerExtract =
//        new CodeMethodExtractResult(
//            callerDeclaredMethodName, null, null, returnType, List.of(), null, null);
//    CodeMethodExtractResult outgoingExtract =
//        new CodeMethodExtractResult(
//            outgoingMethodName, null, null, returnType, List.of(), null, null);
//    assertSoftly(
//        softly -> {
//          softly
