...
class RepoContentRawTextFetcherTest {
  ...
  void fetcherRawTextBlob() {
    ...
    GitTreeFileInfo fileInfo = new GitTreeFileInfo(null, null, ContentType.SOURCE_CODE.getValue(),
        null, fileInfoBlobUrl);
  ...
  void fetcherRawTextTree() {
    ...
    GitTreeFileInfo fileInfo = new GitTreeFileInfo(null, null, ContentType.TREE.getValue(), null,
        fileInfoTreeUrl);
