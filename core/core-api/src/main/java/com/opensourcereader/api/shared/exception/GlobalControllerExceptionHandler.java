package com.opensourcereader.api.shared.exception;
...
public class GlobalControllerExceptionHandler {
  ...
  public ResponseEntity<List<ErrorResponse>> handleBindErrors(BindException exception) {
    List<FieldError> fieldErrors = exception.getBindingResult().getFieldErrors();
  ...
  @ExceptionHandler(OpenSourceReaderException.class)
  public ResponseEntity<ErrorResponse> handleStyleMyClosetException(
      OpenSourceReaderException exception) {
    log.error(
        "커스텀 예외 발생: errorCodeName={}, message={}",
  ...
  public ResponseEntity<?> handleUnexpectedException(
    ...
    if (isSse) {
      log.debug(
          "[SSE] benign disconnect handled quietly: uri={}, ex={}",
    ...
    ErrorResponse errorResponse =
        ErrorResponse.of(exception, HttpStatus.INTERNAL_SERVER_ERROR.value());
